...
export import CorporaCYKParserFactory = require("./Parser/Factory/CorporaCYKParserFactory"); 
export import CYKParser = require("./Parser/CYKParser");
export import GrammarBuilder = require("./Parser/Grammar/GrammarBuilder");
